...
public class LeaveDetailsTest {
  ...
  public final void testLeaveDetailsSetters() throws ParseException {
    ...
    ld.setLeaveAppliedOn(sdf.parse("2020-09-12"));
    ...
    assertEquals(sdf.parse("2020-09-12"), ld.getLeaveAppliedOn());
 ...
 */
  ...
  public final void testapproveById(@Mocked final LeaveDetailsDAO dao) {
    ...
    assertEquals(message, LeaveDetails.approveById(1, "APPROVED"));
  }
  /**
   * @param dao database access object.
   */
  ...
  public final void testViewingLeaveHistory(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    final Date startDate = sdf.parse("2020-01-21");
    final Date endDate = sdf.parse("2020-01-22");
    final Date appliedOn = sdf.parse("2020-01-30");
  ...
  public final void testdenyById(@Mocked final LeaveDetailsDAO dao) {
    ...
    assertEquals(message, LeaveDetails.denyById(4, "DENIED", "NO LEAVE"));
  }
  /**
  ...
  public final void testLeaveApply(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    ...
    assertEquals(message, LeaveDetails.leaveApply(1, sdf.parse("2020-02-26"), sdf.parse("2020-02-29"),
                "EARNED_LEAVE", "tour", "leave"));
  }
}
